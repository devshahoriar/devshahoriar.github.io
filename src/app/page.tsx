...
export default function Home() {
  return (
    <section className="mx-auto w-[950px] flex border my-5">
      {/* // cv sidebar */}
        ...
        <div className="mx-4 mt-10">
          <div className="flex justify-center">
            <Image
              ...
              height={500}
              width={500}
              className="size-64 object-cover rounded-full"
            />
          </div>
          <div className="mt-8">
        ...
        <div className="mx-4 mt-12">
          ...
          <div className="mt-10">
            ...
            <p className="mt-5 text-justify">
              ...
              specializing in <span className="font-bold">MERN</span> stack, as
              a full-stack developer. I can develop scalable{' '}
