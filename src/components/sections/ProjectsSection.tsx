...
import { Database, ExternalLink, Eye, Github, Users, Zap } from 'lucide-react'
...
const featuredProjects = [
  {
    ...
    description:
      "Solely developed a full-stack application from front-end to back-end and database, powering an entire office's operations. Managing over 300,000 tree records, 50,000+ child records, and supporting 80+ employees with daily report generation.",
    technologies: [
      'Next.js',
      'TypeScript',
      'NextAuth',
  ...
  {
    title: 'AI-Powered E-Commerce App with Natural Language Control',
    description:
      'Revolutionary e-commerce interface controlled entirely through natural language commands. Voice-to-action functionality with real-time UI updates and type-safe client-server communication.',
    technologies: [
      'Next.js',
      'tRPC',
      'Hono',
    ...
    githubLink: 'https://github.com/devshahoriar/shop-agent',
    videoLink: 'https://www.youtube.com/watch?v=69i_wSIV8j4',
    isPrivate: false,
    featured: true,
  },
  {
    ...
    description:
      'A powerful, full-stack inventory management solution, Mini ERP built with modern technologies, focusing on performance and scalability for a small business.',
    technologies: [
      'Next.js',
      'TypeScript',
      'PostgreSQL',
...

  {
    ...
    description:
      'A beautiful and intuitive application for downloading high-quality wallpapers and images. Built with modern React technologies for optimal user experience.',
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Real-world applications that solve business problems and create
            value
          </p>
        </motion.div>
          ...
          {featuredProjects
            ...
            .map((project, index) => (
              <motion.div
                ...
                className={project.stats ? 'md:col-span-2' : 'md:col-span-1'}
              >
                <Card className='overflow-hidden hover:shadow-xl transition-all duration-300 group h-full'>
                  <CardContent className='p-0'>
                    <div
                      className={`grid ${
                        project.stats ? 'lg:grid-cols-2' : 'grid-cols-1'
                      } gap-0 h-full`}
                    >
                      {/* Project Info */}
          ...
          <Card className='p-8 bg-gradient-to-r from-primary/5 to-blue-600/5 border-primary/20'>
            <CardContent className='p-0 space-y-6'>
              ...
              <p className='text-muted-foreground'>
                Over 4 years, I've developed multiple proprietary web projects
                for organizations and startups, leveraging my full-stack
                expertise:
              </p>
